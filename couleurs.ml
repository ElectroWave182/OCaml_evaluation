...
(* Fait apparaitre la fenêtre graphique découpée en bandes
   verticales colorées. Les couleurs sont données par une
   liste de triplets (les composantes RVB). L'appui sur 
   touche quelconque fait quitter la fenêtre graphique    *)
